...
if(isset($_POST['submit'])){
    ...
    $sql="insert into `project` (project_name,client_name,project_leader,start_date,end_date,progress)values('$project_name',
    '$client_name','$project_leader', '$start_date', '$end_date', '$progress')";
...
<html lang="en">
  <head>
    ...
    <body>
    <h1 class="row justify-content-center mt-5"> Add New Project</h1>
